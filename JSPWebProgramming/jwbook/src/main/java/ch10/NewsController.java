...
@MultipartConfig(maxFileSize = 1024 *1024*2 , location = "/Users/hee/Desktop/JSPWebProgramming/jwbook/src/main/resources") //뉴스이미지 파일 업로드 처리 위함
public class NewsController extends HttpServlet {
	...
	private String listNews(HttpServletRequest request) {
		System.out.println("listNews 시작");
		List<News> list;
		try {
			list = dao.getAll();
	...
	private String getFilename(Part part) {
		System.out.println("getFilename메소드 시작");
